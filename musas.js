...
lib.ssMetadata = [
		{name:"musas_atlas_1", frames: [[0,0,320,240]]}
];
...
p.nominalBounds = new cjs.Rectangle(0,0,2330,1827);


(lib.CachedBmp_69 = function() {
	this.initialize(img.CachedBmp_69);
}).prototype = p = new cjs.Bitmap();
p.nominalBounds = new cjs.Rectangle(0,0,3232,1812);


(lib.Mapadebits3 = function() {
	this.initialize(ss["musas_atlas_1"]);
	this.gotoAndStop(0);
...
if (reversed == null) { reversed = false; }
	...
	// Capa_1
	this.text = new cjs.Text("COMENZAR", "italic bold 60px 'Tw Cen MT'", "#FFFFFF");
	...
	this.shape.graphics.f("#FF6600").s().p("AwnHnQjKAAiPiPQiOiOAAjKIAAAAQAAjJCOiPQCPiODKAAMAhPAAAQDKAACOCOQCPCPAADJIAAAAQAADKiPCOQiOCPjKAAg");
	...
	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.shape},{t:this.text}]}).to({state:[{t:this.shape_1},{t:this.text}]},1).to({state:[{t:this.shape},{t:this.text}]},1).wait(1));
...
// stage content:
(lib.musas = function(mode,startPosition,loop,reversed) {
if (loop == null) { loop = true; }
if (reversed == null) { reversed = false; }
	var props = new Object();
	props.mode = mode;
	...
	this.frame_1 = function() {
		...
		_this.btn_acceder.on('click', function(){
			...
			if( user_input.value == "Dayana" && contraseña_input.value =="1234"){
	...
	this.instance.setTransform(1082,207,1.5773,1.5773);
	...
	this.btn_comenzar.setTransform(1177.95,769.2);
	new cjs.ButtonHelper(this.btn_comenzar, 0, 1, 2);

	this.instance_1 = new lib.CachedBmp_70();
	this.instance_1.setTransform(444.6,-9.65,0.5,0.5);

	this.text = new cjs.Text("     Paseo \n\"Las Musas\"", "bold 23px 'Script MT Bold'");
	this.text.lineHeight = 30;
	this.text.lineWidth = 135;
	this.text.parent = this;
	this.text.setTransform(64.2598,76.1555,6.564,9.7082);
	...
	this.shape = new cjs.Shape();
	this.shape.graphics.f("#FF6600").s().p("Eh2xBG7MAAAiM4IDVAAMAAACM4gEBzdBF+MAAAiM4IDVAAMAAACM4g");
	this.shape.setTransform(793.9,447.875);

	this.shape_1 = new cjs.Shape();
	this.shape_1.graphics.f("#000066").s().p("Eh98BH5MAAAiPwIHLAAIAAB6MAAACM4IAAA+gEB2yBH4IAAh6MAAAiM4IAAg+IHLAAMAAACPwg");
	this.shape_1.setTransform(793.9,447.875);

	this.timeline.addTween(cjs.Tween.get({}).to({state:[{t:this.instance_2},{t:this.text,p:{scaleX:6.564,scaleY:9.7082,x:64.2598,y:76.1555,text:"     Paseo \n\"Las Musas\"",font:"bold 23px 'Script MT Bold'",color:"#000000",lineHeight:29.7,lineWidth:135}},{t:this.instance_1},{t:this.btn_comenzar}]}).to({state:[{t:this.shape_1},{t:this.shape},{t:this.text_2},{t:this.usuario},{t:this.contra},{t:this.text_1},{t:this.text,p:{scaleX:1,scaleY:1,x:268.4,y:517,text:"Contraseña:",font:"bold 83px 'Script MT Bold'",color:"#990000",lineHeight:101.95,lineWidth:416}},{t:this.btn_acceder}]},1).wait(1));

	this._renderFirstFrame();

}).prototype = p = new lib.AnMovieClip();
p.nominalBounds = new cjs.Rectangle(787.8,437.8,826.2,470.2);
// library properties:
lib.properties = {
	...
	opacity: 1.00,
	manifest: [
		{src:"images/CachedBmp_70.png?1736513040872", id:"CachedBmp_70"},
		{src:"images/CachedBmp_69.png?1736513040872", id:"CachedBmp_69"},
		{src:"images/musas_atlas_1.png?1736513040851", id:"musas_atlas_1"},
		{src:"https://code.jquery.com/jquery-3.4.1.min.js?1736513040872", id:"lib/jquery-3.4.1.min.js"},
		{src:"components/sdk/anwidget.js?1736513040872", id:"sdk/anwidget.js"},
		{src:"components/ui/src/textinput.js?1736513040872", id:"an.TextInput"}
	],
	preloads: []
};
